        ...
        if(fichier) // si l'ouverture a réussi
            {
                ...
                Sleep(70), cout <<" ", Sleep(70), cout <<"K", Sleep(70), cout <<"a", Sleep(70), cout <<"r", Sleep(70), cout <<"t", Sleep(70), cout <<"h", Sleep(70), cout <<"i", Sleep(70), cout <<"g", Sleep(70), cout <<"e", Sleep(70), cout <<"s", Sleep(70), cout <<"u";
                Sleep(70);
                Sleep(70);
